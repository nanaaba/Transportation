                            ...
                            <div class="card-body collapse in">
                                <div class="card-block card-dashboard">
                                    <table class="table table-striped table-bordered dataex-html5-export">
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $cumm_maintenance; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $single): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td><?php echo e($single->car_number); ?> </td>
                                                <td><?php echo e($single->purchased_date); ?> </td>
                                                <td><?php echo e($single->date_car_assigned); ?> </td>
                                                <td>GHS <?php echo e($single->total_amount); ?> </td>
