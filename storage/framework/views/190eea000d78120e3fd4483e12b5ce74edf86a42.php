...
$allcolors = json_decode($fueltypes);
?>
...
<aside class="right-side">
    ...
    <section class="content">
        <?php
        if (in_array("ADD_FUELTYPE", $permissions)) {
            ?>
            <div class="">
                            ...
                            <table class="table table-striped table-bordered table-hover" id="table">
                                <thead>
                                    <tr>
                                        ...
                                        <?php
                                        if (in_array("DELETE_FUELTYPE", $permissions)) {
                                            ?>
                                            <th>Action</th>
                                            <?php
                                        }
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#" onclick="deleteFuelType(<?php echo e($single->id); ?>,'<?php echo e($single->name); ?>')"   class="btn btn-outline-info btn-sm btn-edit editBtn" ><i class="fa fa-trash" ></i><span class="hidden-md hidden-sm hidden-xs"> </span></a>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="exampleModalLabel">New FuelType</h4>
                    </div>
                    <form class="form-horizontal" role="form" id="NewForm">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="region" class="control-label">FuelType:</label>
...
<script type="text/javascript">
    ...
    function deleteFuelType(code, title) {
    ...
    $('input:submit').attr("disabled", true);
    $.ajax({
    url: "<?php echo e(url('savefueltype')); ?>",
            type: "POST",
            data: formData,
            success: function (data) {
            console.log(data);
            ...
            if (data == 0) {
            swal("Success!", "Fuel Type Added", "success");
            getFuelTypes();
            } else if (data == 1) {
