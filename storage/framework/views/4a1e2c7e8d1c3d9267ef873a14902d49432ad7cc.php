    ...
    <div class="content-wrapper">
        <div class="content-header row">
            <div class="content-header-left col-md-6 col-xs-12 mb-2">
                <h3 class="content-header-title mb-0">Banks</h3>
                <div class="row breadcrumbs-top">
                    <div class="breadcrumb-wrapper col-xs-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Banks
                            </li>
                        </ol>
                    </div>
                </div>
        ...
        <div class="content-body"><!-- DOM - jQuery events table -->
            ...
            $result = json_decode($banks);
            if (in_array("ADD_BANKS", $permissions)) {
                ?>
                                    ...
                                    <table id="table" class="table table-striped table-bordered ">
                                        <thead>
                                            <tr>
                                                ...
                                                <?php
                                                if (in_array("DELETE_BANKS", $permissions)) {
                                                    ?>
                                                    <th>Action</th>
                                                    <?php
                                                }
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="#" onclick="deleteBank(<?php echo e($single->id); ?>)"   class="btn btn-outline-info btn-sm btn-edit editBtn" ><i class="fa fa-trash" ></i><span class="hidden-md hidden-sm hidden-xs"> </span></a>
            ...
            url: "<?php echo e(url('getbanks')); ?>",
                    ...
                    var rowNum = 0;
                            ...
                            var j = - 1;
                                    ...
                                    r[++j] = '<td><a href="#" onclick="deleteBank(' + value.id + ')"   class="btn btn-outline-info btn-sm btn-edit editBtn" ><i class="fa fa-trash" ></i><span class="hidden-md hidden-sm hidden-xs"> </span></a></td>';
                                    rowNum = rowNum + 1;
