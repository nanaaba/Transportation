                                   ...
                                   <thead>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $single->name }} </td>
                                            <td>{{ $single->date_assigned }} </td>
                                            <td>
                                                <button type="button" onclick="donotemodal('{{ $single->car_number_id }}')"  class="mr-1 mb-1 btn btn-outline-primary btn-sm"><i class="fa fa-plus"></i> Note</button>
                                            </td>
                                        </tr>
                                        @endforeach
...
<script type="text/javascript" src="{{asset('js/assigndrivers.js')}}"></script
