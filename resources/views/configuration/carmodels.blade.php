                            ...
                            <table class="table table-striped table-bordered table-hover" id="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{$single->name}}</td>
                                        <td>
                                            <a href="#" onclick="deleteColor({{$single->id}})"   class="btn btn-outline-info btn-sm btn-edit editBtn" ><i class="fa fa-trash" ></i><span class="hidden-md hidden-sm hidden-xs"> </span></a>
