                            ...
                            <div class="card-body collapse in">
                                <div class="card-block card-dashboard">
                                    <table id="table" class="table table-striped table-bordered ">
                                        ...
                                        <tbody>
                                            @foreach($modelyears as $single)
                                            <tr>
                                                <td>{{$single->name}}</td>
                                                <td>
                                                    <a href="#" onclick="deleteYear({{$single->id}})"   class="btn btn-outline-info btn-sm btn-edit editBtn" ><i class="fa fa-trash" ></i><span class="hidden-md hidden-sm hidden-xs"> </span></a>
