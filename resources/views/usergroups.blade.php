                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="#" onclick="editUserGroup({{$single->id}},'{{$single->name}}')"   class="btn btn-outline-info btn-sm btn-edit editBtn" ><i class="fa fa-pencil" ></i><span class="hidden-md hidden-sm hidden-xs"> </span></a>

                                                    <a href="#" onclick="deleteUserGroup({{$single->id}})"   class="btn btn-outline-info btn-sm btn-edit editBtn" ><i class="fa fa-trash" ></i><span class="hidden-md hidden-sm hidden-xs"> </span></a>
